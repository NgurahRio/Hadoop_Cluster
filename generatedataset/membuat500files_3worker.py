...
output_folder = "../datasets/skenario-worker/3worker"
...
for i in range(1, jumlah_file + 1):
    ...
    selected_sentences = random.choices(sentences, k=1000)
...
print("500 distributed large text files berhasil dibuat.")